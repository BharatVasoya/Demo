...
class TextComponent extends React.Component {
  ...
  render() {
    const stylesArray = [];
    if (this.props.large) {
      stylesArray.push({fontSize: Constants.LARGE});
    } else if (this.props.normal) {
      stylesArray.push({fontSize: Constants.NORMAL});
    } else if (this.props.small) {
      stylesArray.push({fontSize: Constants.SMALL});
    } else if (this.props.extraSmall) {
      stylesArray.push({fontSize: Constants.EXTRA_SMALL});
    } else if (this.props.extraLarge) {
      stylesArray.push({fontSize: Constants.EXTRA_LARGE});
    } else if (this.props.xxxLarge) {
      stylesArray.push({fontSize: Constants.XXXLARGE});
    } else {
      stylesArray.push({fontSize: Constants.NORMAL});
    }
